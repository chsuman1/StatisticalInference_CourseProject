...
#Calculate the mean of the sinulated means. This tells us where the simulation means are centered.
...
library (ggplot2)
par(mfrow = c(1,1))
q <- ggplot(data.frame(simulatedExponentialMeans), aes(x = simulatedExponentialMeans)) + geom_histogram(alpha = 0.2, binwidth=0.3, colour = "black", aes(y = ..density..)) + geom_density()
q
